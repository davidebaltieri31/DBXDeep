...
#pragma region CONSTRUCTORS	
		public:
			...
			SoftMaxLayer(const SoftMaxLayer& l) = delete;

			SoftMaxLayer(SoftMaxLayer&& l) : Layer(std::move(l)) {
			}

			SoftMaxLayer& operator=(SoftMaxLayer& l) = delete;

			SoftMaxLayer& operator=(SoftMaxLayer&& l) {
